...
sns.scatterplot(data=filtered_df, x='Quantity', y='Value', color='orange')
...
sns.barplot(x=shipping_agg.index, y=shipping_agg.values, palette='Dark2')
...
sns.barplot(x=top_products.values, y=top_products.index, palette='Paired')
...
sns.barplot(x=top_suppliers.index, y=top_suppliers.values, palette='Set3')
...
sns.barplot(x=port_agg.index, y=port_agg.values, palette='Set1')
...
sns.scatterplot(data=filtered_df, x='Weight', y='Value', color='purple')
...
sns.barplot(x=payment_terms_count.index, y=payment_terms_count.values, palette='viridis')
