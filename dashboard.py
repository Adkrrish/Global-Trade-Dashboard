...
@st.cache_data
def load_data("D:\\MBA materials\\Trimester 1\\DEVP(AMitra)\\Imports_Exports_Dataset.csv"):
    return pd.read_csv("D:\\MBA materials\\Trimester 1\\DEVP(AMitra)\\Imports_Exports_Dataset.csv")

# Use relative path or allow user to upload a file
dataset = load_data("Imports_Exports_Dataset.csv")
